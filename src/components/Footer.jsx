...
//               <div><Button className="bg-gradient-to-r from-violet-300 to-indigo-500 hover:from-violet-600 hover:to-indigo-600 text-white rounded-full">
//                 Get Your Estimate
//               </Button></div>
//             </div>
//            </div>
  ...
  return (
    <footer className="bg-violet-900 text-violet-100 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-violet-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0">Copyright&copy; InnoApps 2024</p>
          <div className="flex space-x-4 text-sm">
            <Link href="#" className="hover:text-violet-300">
              Terms & Condition
            </Link>
